...
const NouvelEvenement = ({ onAjoutReussi }) => {
  ...
  const valider = () => {
    const e = {};
    if (titre.trim().length < 3) e.titre = "Le titre doit contenir au moins 3 caracteres.";
    if (lieu.trim().length < 2) e.lieu = "Le lieu est requis.";
    if (prix < 0) e.prix = "Le prix ne peut pas etre negatif.";
    return e;
  };
